...
if ($debug) {
    echo "<pre class=debug>VF_Z_E_Ed_su_ph0.inc.php ist gestarted</pre>";
}
...
Edit_Daten_Feld('fs_urh_nr', 15);

Edit_Daten_Feld('fs_urh_kurzz', 15);
Edit_Daten_Feld('fs_urh_verzeich', 15);

Edit_Daten_Feld('fs_anz_verze');
Edit_Daten_Feld('fs_anz_dateien');
...
echo "<p><a href='VF_Z_E_Edit.php?ID=".$neu['fs_eigner'].">Zurück zur Liste</a></p>";

if ($debug) {
    echo "<pre class=debug>VF_Z_E_U_Ed_su_ph0.inc.php beendet</pre>";
}
?>