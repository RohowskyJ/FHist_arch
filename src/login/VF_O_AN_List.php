...
function modifyRow(array &$row,$tabelle)
{
    ...
    if ($row['bs_bild_1'] != "") {
        ...
        if ($dn_a['extension'] == "pdf" || $dn_a['extension'] == 'doc') {
            $image2 = "<a href='".$path2ROOT ."login/AOrd_Verz/Biete_Suche/$bs_bild_1' > $bs_bild_1 </a>";
        } else {
            $aord_sp = "";
            ...
            if ($cnt_fo >= 3) {   // URH-Verz- Struktur de dsn
                ...
                $image2 = $pict_path.$urh."09/".$aord_sp.$verz.$bs_bild_1;
                
                if (!is_file($image2)) {
                    $image2 = $pict_path . $bs_bild_1;
                }
            } else {
                $image2 = $pict_path . "Biete_Suche/". $bs_bild_1;
            }
