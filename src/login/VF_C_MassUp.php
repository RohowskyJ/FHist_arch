...
if (isset($_GET['typ'])) { 
    $_SESSION[$module]['Up_Typ'] = $_GET['typ'];
}
...
if ($phase == 1) {
    ...
    if ($_SESSION[$module]['Up_Typ'] == 'Arch') {
       ...
       # require "VF_C_MassUp_FO_ph1.inc.php";
    }
...
if ($phase == 3) {   
    if ($_SESSION[$module]['Up_Typ'] == 'Arch') {
        require "VF_C_MassUp_AR_ph3.inc.php";
        $phase = 2;
    } else {
        require "VF_C_MassUp_FO_ph3.inc.php";
        $phase = 1;
    }
}
...
switch ($phase) {
    case 0:
        if ($_SESSION[$module]['Up_Typ'] == 'Arch') {
            require 'VF_C_MassUp_AR_ph0.inc.php';
        } else {
            VF_Auto_Eigent('U', true);
        }
        break;
    ...
    case 1:
        require 'VF_C_MassUp_FO_ph1.inc.php'; // Ziel nach Archiv-Ordnung feststellen, Pfad der Source- Bilder abfragen
        break;
    case 2:
        
        require 'VF_C_MassUp_ph2.inc.php'; // Pfade und Tabellen feststellen und die Tabeleninhalte erstellen (lassen)
        break;
}
