 ...
 */
$_SESSION[$module]['Inc_Arr'][] = "VF_PS_OV_FW_List.php"; 
...
$NeuRec = " &nbsp; &nbsp; &nbsp; <a href='VF_PS_OV_FW_Edit.php?ID=0' > Neuen Datensatz anlegen </a>";
...
echo "<pre class=debug style='background-color:lightblue;font-weight:bold;'>PS_OV_FW List vor list_create $sql_ow </pre>";
echo "</div>";
