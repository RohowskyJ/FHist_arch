...
const Tabellen_Name = 'aw_ort_ref';
...
$_SESSION[$module]['Inc_Arr'][] = "VF_PS_OV_O_List.php"; 
...
switch ($_SESSION[$module]['proj']) {
    case "AERM":
        ...
        if ($_SESSION[$module]['all_upd']) {
            ...
            $NeuItem = "<a href='VF_PS_OV_O_Edit.php?ID=0' > Neuen Datensatz anlegen </a>";
        } else {
    ...
    case "AUSZ":
        ...
        if ($_SESSION[$module]['all_upd']) {
            ...
            $NeuItem = "<a href='VF_PS_OV_M_Edit.php?ID=0'";
        } else {
...
$jq_tabsort = $jq = true;
BA_HTML_header($htext,  '', 'Admin', '150em'); # Parm: Titel,Subtitel,HeaderLine,Type,width
...
if (isset($_SESSION[$module]['T_List']) && $_SESSION[$module]['T_List'] == 'Neuitem') {
    $_SESSION[$module]['T_List'] = "";
}
...
$NeuRec = " &nbsp; &nbsp; &nbsp; $NeuItem > Neuen Datensatz anlegen </a>";
    ...
    case "AERM":
        switch ($T_List) {
            case "Alle":
                ...
                break;
            default:
                $Tabellen_Spalten = array('fw_id','fw_aermelw','fw_st_abk','fw_bd_abk','fw_bz_abk','fw_bz_name','fw_ab_nr','fw_ab_name','fw_gd_name','fw_gd_art',
                    'fw_fw_nr','fw_fw_name','fw_fw_typ', 'fw_grdg_dat','fw_end_dat','fw_kommentar','fw_ort_komm'
                );
        }
        break;
    ...
    case "AUSZ":
        switch ($T_List) {
            case "Alle":
                ...
                break;
            default:
                $Tabellen_Spalten = array('fw_id','fw_auszeich','fw_st_abk','fw_bd_abk','fw_bz_abk','fw_bz_name','fw_ab_nr','fw_ab_name','fw_gd_name', 'fw_gd_art',
                    'fw_fw_nr','fw_fw_name','fw_fw_typ','fw_grdg_dat','fw_end_dat','fw_kommentar','fw_ort_komm'
                );
        }
        break;
...
echo "<pre class=debug style='background-color:lightblue;font-weight:bold;'>PS_OV_O List vor list_create $sql </pre>";
echo "</div>";
...
# echo "<br>L 285 modrow $tabelle <br>";
    ...
    $row['fw_id'] = "<a href='VF_PS_OV_O_Edit.php?ID=$fw_id'  >" . $fw_id . "</a>";
