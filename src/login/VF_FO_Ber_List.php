...
if (isset($_GET['Act'])) {
    IF ( $_GET['Act'] == 1) {
        $_SESSION[$module][$sub_mod]['Act'] = $Act = $_GET['Act'];
        VF_chk_valid();
        VF_set_module_p();
    } else {
        if (!isset($_SESSION[$module][$sub_mod]['Act'])){
            $_SESSION[$module][$sub_mod]['Act'] = $Act = $_GET['Act'];
            $_SESSION[$module][$sub_mod]['p_uid'] = 999999999;
            $_SESSION[$module]['all_upd'] = False;
        }
    }
}
...
{
    global $path2VF, $T_List, $module, $sub_mod;
# var_Dump($row);
    ...
    switch ($s_tab) {
        ...
        */
        case "vb_beric":
            ...
            if ($_SESSION[$module][$sub_mod]['Act'] == 0 ) {
                $row['vb_flnr'] = "<a href='VF_FO_Bericht.php?vb_flnr=" . $vb_flnr . "'  >" . $vb_flnr . " Bericht</a>";
            } else {
                $row['vb_flnr'] = "<a href='VF_FO_Ber_Edit.php?vb_flnr=" . $vb_flnr . "'  >" . $vb_flnr . "</a><hr><a href='VF_FO_Bericht.php?vb_flnr=" . $vb_flnr . "'  >" . $vb_flnr . " Bericht</a>";
            }
            ...
            if ($row['vb_foto'] != "") {
             ...
             #   VF_Displ_Urheb($row['vb_urheb']);
                ...
                $image1 = "<img src='$DsName' alt='Foto1' width='200px'/> ";
