...
echo "<div class='w3-row' >"; // Beginn der Einheit Ausgabe
echo "<p>Die Grundlegende Archivordnung ist im OBFV- Feuerwehrgeschichte definiert und hat zwei Ebenen.</p>";
echo "<p>Die erweiterte Archivordung nutzt die Definierte Ordnung und fügt vier Ebenen hinzu, die in der Basis zu grob definiert sind,
     und für die genauere Suche hilfreich sind.</p>";
...
echo "<div class='w3-row' >"; // Beginn der Einheit Ausgabe
echo "<p>Hier können die die digitalisierten Dokumente massenweise (je Gruppe innerhalb der Archivordnung) geladen und die Tabelle für die 
Dokumente in den jeweiligen Archivordnung werden erstellt. Die Beschreibungen müssen dann in der Archivalien-Verwaltung eingegeben werden. </p>";
# echo "<a href='VF_A_AR_MassUp.php?sk=$sk&Act=l' target='Arch'>Massen- Upload von Dokumenten</a> <br>";
echo "<a href='VF_C_MassUp.php?sk=$sk&typ=Arch' target='Upl_AR'> Archivalien- Massen- Upload (PDF- Dateien, Fotos)</a>";
echo "</div>";
